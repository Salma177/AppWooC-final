...
<html lang="en">
  ...
  <body style="background: linear-gradient(90deg, rgba(179,175,251,1) 0%, rgba(99,99,244,1) 35%, rgba(217,0,241,1) 100%);">
        <div class="row justify-content-center">
             <section>
                <h1 style="margin-top:30px;margin-bottom:30px;"> Modifier une commande</h1>
                <div class="card ">
                    
                    <form class="card-body" action="updateO.php">
                    <div class="form-group">
                    <label form="OrderId">Id :</label>
                    <input type="text" class="form-control" name="id" id="id" value="<?= $_GET['id']; ?>"; required />
                    </div>
                        <div class="form-group">
                            <label form="orderStatus">Statut de la commande :</label>
